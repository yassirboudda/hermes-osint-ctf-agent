...
- Sub-agents: **OpenRouter** (any model DeepSeek selects)

## Delegation
Hard OSINT / long context / vision → OpenRouter sub-agent; parent stays DeepSeek.
...
- `../tools/` — CTFd, OSINTMapper, OSINT Industries helpers
